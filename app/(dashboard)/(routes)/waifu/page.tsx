...
const WaifuPage = () => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            setImages([]);
            const response = await axios.post("/api/waifu", values);
    ...
    return (
        <div>
            <Heading
                title="Waifu Generation"
                description="Generate Waifus from a prompt."
                Icon={ImageIcon}
                                    ...
                                    <FormItem className="col-span-12 lg:col-span-6">
                                        <FormControl className="m-0 p-0">
                                            <Input 
                                                ...
                                                disabled={isLoading}
                                                placeholder="A Pixar 3D render of a cat exploring the beach."
                                                {...field}
                                            />
                                        </FormControl>
                                    </FormItem>    
